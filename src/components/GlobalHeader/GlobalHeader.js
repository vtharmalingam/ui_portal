...
export default class GlobalHeader extends PureComponent {
  ...
  render() {
    ...
    const {
      ...
      // Global Search Text Field Related
      onChangeFired, onSearchFired
    } = this.props;
      ...
      <div className={styles.header}>
        ...
        <div className={styles.right}>          
          ...
          {/* <HeaderSearch
            ...
            onPressEnter={onSearchFired}
            //Once user presses enter we need to cpature the text and move to parent container of this
            // onPressEnter={(value) => {
