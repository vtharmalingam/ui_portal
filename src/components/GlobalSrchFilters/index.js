...
export default class GlobalSrchFilters extends PureComponent {
  ...
  showSearchbyOptions = (data) => {
    ...
    return (
      <Dropdown style={{ width: '16em', fontSize: '10px' }} optionLabel="heading" value={this.state.searchByVal}
  ...
  showSearchModes = (data) => {
    ...
    return (
      <MultiSelect style={{ width: '8em', fontSize: '10px' }} optionLabel="label" value={this.state.modes}
  ...
  showDataMarts = (data) => {
    ...
    return (
      <MultiSelect style={{ width: '8em', fontSize: '10px' }} optionLabel="label" value={this.state.datamarts}
  ...
  showCountries = (data) => {
    ...
    return (
      ...
      <Dropdown style={{ width: '8em', fontSize: '10px' }} value={this.state.countrySelected} options={countries}

        onChange={this.handleCountryChange} itemTemplate={this.countryTemplate}
        filter={true} filterPlaceholder="Select Country"
        filterBy="code,name" showClear={true} />
    )
  }
  ...
  handleCountryChange = (e) => {
    console.log("country value is:" + e.code + e.name + e.label);
  ...
  managePrimaryAdditionalInfo = () => {
    ...
    this.setState({ showPrimaryAdditionalInfo: true, showSecondaryAdditionalInfo: true,
      selectedPrimaryAdditionalInfo:{},selectedSecondaryAdditionalInfo:{},primaryAdditionalInfo:[],secondaryAdditionalInfo:[] });
    ...
    if (this.state.datamarts.length == 1) {
      ...
      additioanlinfoConifg.forEach(configObject => {
        if (configObject.id == this.state.datamarts[0].id) {
          ...
          var additionInfo = configObject['field'];
          ...
          this.setState({ primaryAdditionalInfo: additionInfo,selectedPrimaryAdditionalInfo:{},showPrimaryAdditionalInfo:true });
        }
      });
    }
  }
