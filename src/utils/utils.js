...
{
  if(str){
    var removedUnderscoresText = str.replace(/_/g, ' ');
    return removedUnderscoresText.replace(/\w\S*/g, function(txt){return txt.charAt(0).toUpperCase() + txt.substr(1).toLowerCase();});
  }
...
//Generates the columns through config file...
export function getColumnsGeneratedbyConfig(config,lookupName) {
